    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        ...
        return httpSecurity
                ...
                .authorizeHttpRequests(auth -> auth
                        //public endpoints
                        .requestMatchers("/api/auth/login", "/api/auth/register", "/api/auth/refresh-token", "/api/central-units/register", "/access/hello", "/api/central-units/all", "/api/central-units/unoccupied", "/access/request").permitAll()
                        //protected endpoints
